...
<body>
    ...
    <aside class="sidebar">
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/adherant/mes-prets">
            ...
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/adherant/mes-reservations">
